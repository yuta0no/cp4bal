...
from torch_geometric.transforms import Compose, LargestConnectedComponents, ToUndirected

from .base import GraphDataset
from .configs import TorchGeometricDataConfig
from .enums import TorchGeometricDatasetType


class TorchGeometricDataset(GraphDataset):
    ...
    def __init__(self, config: TorchGeometricDataConfig):
        ...
        edge_indices = tg_dataset.edge_index  # type: ignore
